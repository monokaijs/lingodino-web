          ...
          {isLoading ? (
            ...
            >
              <Table>
                ...
                <TableBody>
                  <SortableContext
                    items={optimisticLessons.map((l) => l._id)}
                  ...
                  <Table>
                    <TableBody>
                      <TableRow>
                        ...
                        <TableCell>
                          {optimisticLessons.find(l => l._id === activeId)?.description}
                        </TableCell>
                        <TableCell>
                          <div className="flex gap-2">
                            <Button variant="ghost" size="icon-sm"><IconEdit className="h-4 w-4" /></Button>
                            <Button variant="ghost" size="icon-sm"><IconTrash className="h-4 w-4" /></Button>
                          </div>
                        </TableCell>
                      </TableRow>
                    </TableBody>
