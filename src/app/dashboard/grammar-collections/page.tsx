...
async function fetchCollections(): Promise<GrammarCollection[]> {
...
export default function GrammarCollectionsPage() {
  ...
  const handleEdit = (collection: GrammarCollection) => {
                  ...
                  <TableRow key={collection._id}>
                    <TableCell>
                      <div className="flex items-center gap-3">
                        ...
                        <Link href={`/dashboard/grammar-collections/${collection._id}`} className="font-medium hover:underline">
                          {collection.name}
                        </Link>
                      </div>
                    </TableCell>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this collection? All grammar items will be deleted. This action cannot be undone.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
